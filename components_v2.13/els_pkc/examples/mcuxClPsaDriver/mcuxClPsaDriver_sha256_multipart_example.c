...
bool mcuxClPsaDriver_sha256_multipart_example(void)
{
...
bool nxpClPsaDriver_sha256_multipart_example(void)
{
    bool result = mcuxClPsaDriver_sha256_multipart_example();
    return result;
}
