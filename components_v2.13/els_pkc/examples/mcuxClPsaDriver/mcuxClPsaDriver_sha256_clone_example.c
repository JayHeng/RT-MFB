...
bool mcuxClPsaDriver_sha256_clone_example(void)
{
    ...
    psa_status_t clone_result = psa_driver_wrapper_hash_clone(
        &hashOperation,                      // const psa_hash_operation_t *source_operation
        &clonedHashOperation);               // psa_hash_operation_t *target_operation
    ...
    psa_status_t update2_result = psa_driver_wrapper_hash_update(
        &clonedHashOperation,                // psa_hash_operation_t *operation
        data + 32u,                          // const uint8_t *input
        sizeof(data) - 32u);                 // size_t input_length
