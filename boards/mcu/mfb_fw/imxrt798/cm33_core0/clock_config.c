...
void BOARD_BootClockRUN_InitClockModule(clock_module_t module)
{
    switch(module) {
        case kClockModule_FRO0:
            ...
            if (kStatus_Success != CLOCK_EnableFroClkFreqCloseLoop(FRO0, &g_fro0Config_BOARD_BootClockRUN, kCLOCK_FroDiv1OutEn | kCLOCK_FroDiv2OutEn | kCLOCK_FroDiv3OutEn | kCLOCK_FroDiv6OutEn | kCLOCK_FroDiv8OutEn)) {
                ...
                CLOCK_EnableFroClkOutput(FRO0, kCLOCK_FroDiv1OutEn | kCLOCK_FroDiv2OutEn | kCLOCK_FroDiv3OutEn | kCLOCK_FroDiv6OutEn | kCLOCK_FroDiv8OutEn);
            }
#else
...
void BOARD_BootClockHSRUN_InitClockModule(clock_module_t module)
{
    switch(module) {
        case kClockModule_FRO0:
            ...
            /* Configure FRO clock module in closed loop (autotrimming) mode. */
#if (FSL_CLOCK_DRIVER_VERSION >= MAKE_VERSION(2, 5, 0))
            if (kStatus_Success != CLOCK_EnableFroClkFreqCloseLoop(FRO0, &g_fro0Config_BOARD_BootClockHSRUN, kCLOCK_FroDiv1OutEn | kCLOCK_FroDiv2OutEn | kCLOCK_FroDiv3OutEn | kCLOCK_FroDiv6OutEn | kCLOCK_FroDiv8OutEn)) {
                /* If the close loop not lock, switch to open loop mode and search the nearest target frequency. */
                CLOCK_FroFineTune(FRO0, g_fro0Config_BOARD_BootClockHSRUN.targetFreq, (uint16_t)(FRO0->AUTOTRIM.RW & FRO_AUTOTRIM_AUTOTRIM_MASK));
                CLOCK_EnableFroClkOutput(FRO0, kCLOCK_FroDiv1OutEn | kCLOCK_FroDiv2OutEn | kCLOCK_FroDiv3OutEn | kCLOCK_FroDiv6OutEn | kCLOCK_FroDiv8OutEn);
            }
#else
