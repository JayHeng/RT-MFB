...
const uint32_t s_customLUT_MXIC_Quad[CUSTOM_LUT_LENGTH] = {
    ...
    [4 * NOR_CMD_LUT_SEQ_IDX_READ + 1] =
        FLEXSPI_LUT_SEQ(kFLEXSPI_Command_MODE8_SDR, kMIXSPI_4PAD, 0x00, kFLEXSPI_Command_DUMMY_SDR, kMIXSPI_4PAD, MXIC_QUAD_FLASH_DUMMY_CYCLES - 2),
    ...
    [4 * NOR_CMD_LUT_SEQ_IDX_READREG] =
        FLEXSPI_LUT_SEQ(kFLEXSPI_Command_SDR,       kMIXSPI_1PAD, 0x15, kFLEXSPI_Command_READ_SDR,  kMIXSPI_1PAD, 0x01),

    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /* Enter QPI mode */
    [4 * NOR_CMD_LUT_SEQ_IDX_ENTERQPI] =
        FLEXSPI_LUT_SEQ(kFLEXSPI_Command_SDR,       kMIXSPI_1PAD, 0x35, kFLEXSPI_Command_STOP,      kMIXSPI_1PAD, 0x00),
...
const uint32_t s_customLUT_MXIC_Octal[CUSTOM_LUT_LENGTH] = {
    ...
    [4 * NOR_CMD_LUT_SEQ_IDX_READ + 0] =
        FLEXSPI_LUT_SEQ(kFLEXSPI_Command_DDR,       kMIXSPI_8PAD, 0xEE, kFLEXSPI_Command_DDR,       kMIXSPI_8PAD, 0x11),
    ...
    /*  FAST READ4B */
    [4 * NOR_CMD_LUT_SEQ_IDX_READ + 0] =
        FLEXSPI_LUT_SEQ(kFLEXSPI_Command_SDR,       kMIXSPI_1PAD, 0x0C, kFLEXSPI_Command_RADDR_SDR, kMIXSPI_1PAD, 0x20),
    [4 * NOR_CMD_LUT_SEQ_IDX_READ + 1] = 
        FLEXSPI_LUT_SEQ(kFLEXSPI_Command_DUMMY_SDR, kMIXSPI_1PAD, MXIC_OCTAL_FLASH_DUMMY_CYCLES, kFLEXSPI_Command_READ_SDR,  kMIXSPI_1PAD, 0x04),
#endif
    ...
    [4 * NOR_CMD_LUT_SEQ_IDX_SETDUMMY] =
        FLEXSPI_LUT_SEQ(kFLEXSPI_Command_SDR,       kMIXSPI_1PAD, 0x72, kFLEXSPI_Command_SDR,       kMIXSPI_1PAD, 0x00),
    ...
    [4 * NOR_CMD_LUT_SEQ_IDX_SETDUMMY + 2] =
        FLEXSPI_LUT_SEQ(kFLEXSPI_Command_SDR,       kMIXSPI_1PAD, 0x00, kFLEXSPI_Command_WRITE_SDR, kMIXSPI_1PAD, 0x01),
    ...
    [4 * NOR_CMD_LUT_SEQ_IDX_READSTATUS_OPI] =
        FLEXSPI_LUT_SEQ(kFLEXSPI_Command_DDR,       kMIXSPI_8PAD, 0x05, kFLEXSPI_Command_DDR,       kMIXSPI_8PAD, 0xFA),
    ...
    [4 * NOR_CMD_LUT_SEQ_IDX_WRITEENABLE_OPI] =
        FLEXSPI_LUT_SEQ(kFLEXSPI_Command_DDR,       kMIXSPI_8PAD, 0x06, kFLEXSPI_Command_DDR,       kMIXSPI_8PAD, 0xF9),

    /* Erase Sector - OPI */
    [4 * NOR_CMD_LUT_SEQ_IDX_ERASESECTOR_OPI] =
        FLEXSPI_LUT_SEQ(kFLEXSPI_Command_DDR,       kMIXSPI_8PAD, 0x21, kFLEXSPI_Command_DDR,       kMIXSPI_8PAD, 0xDE),
    ...
    [4 * NOR_CMD_LUT_SEQ_IDX_PAGEPROGRAM_OPI] =
        FLEXSPI_LUT_SEQ(kFLEXSPI_Command_DDR,       kMIXSPI_8PAD, 0x12, kFLEXSPI_Command_DDR,       kMIXSPI_8PAD, 0xED),
    [4 * NOR_CMD_LUT_SEQ_IDX_PAGEPROGRAM_OPI + 1] = 
    ...
    [4 * NOR_CMD_LUT_SEQ_IDX_READREG + 0] =
        FLEXSPI_LUT_SEQ(kFLEXSPI_Command_DDR,       kMIXSPI_8PAD, 0x15, kFLEXSPI_Command_DDR,       kMIXSPI_8PAD, 0xEA),
    ...
    [4 * NOR_CMD_LUT_SEQ_IDX_READREG2 + 0] =
        FLEXSPI_LUT_SEQ(kFLEXSPI_Command_DDR,       kMIXSPI_8PAD, 0x71, kFLEXSPI_Command_DDR,       kMIXSPI_8PAD, 0x8E),
