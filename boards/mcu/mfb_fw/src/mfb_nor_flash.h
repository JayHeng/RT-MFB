...
#define WINBOND_DEVICE_W25QxxxCL    (1)  // Small package not supported on MIMXRT1180-MEM-BB&DS
...
#define WINBOND_DEVICE_W25QxxxNW    (1)  // MIMXRT1170-EVKB_Rev.Cx (W25Q512NW), MIMXRT1170-FSGPIO_Rev.A (W25Q512NW)
...
#define ISSI_DEVICE_IS25LP512M      (1)
