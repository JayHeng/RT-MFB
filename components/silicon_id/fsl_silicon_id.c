...
#if defined(OCOTP) && defined(OCOTP_OTP_LOCK_STICKY_0_LOCK_STICKY_BIT0_MASK)
#include "fsl_ocotp.h"
#elif defined(SIM)
#include "fsl_sim.h"
...
#elif defined(OCOTP_OTP_LOCK_STICKY_0_LOCK_STICKY_BIT0_MASK)
    result = OCOTP_ReadUniqueID(&siliconId[0], idLen);
