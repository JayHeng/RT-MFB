 ...
 */
#define MCUXCLHMAC_MAX(value0, value1)  (((value0) > (value1)) ? (value0) : (value1))
...
/* Workarea sizes */
#define MCUXCLHMAC_COMPUTE_CPU_WA_BUFFER_SIZE            MCUXCLHMAC_MAX(MCUXCLHMAC_MAX(360u , 4u), 168u)
...
#define MCUXCLHMAC_MAX_CPU_WA_BUFFER_SIZE                MCUXCLHMAC_MAX(MCUXCLHMAC_MAX(360u , 4u), 168u)
#define MCUXCLHMAC_MAX_CPU_WA_BUFFER_SIZE_IN_WORDS       MCUXCLHMAC_SIZE_IN_CPUWORDS(MCUXCLHMAC_MAX_CPU_WA_BUFFER_SIZE)

/* Context sizes */
#define MCUXCLHMAC_CONTEXT_SIZE_SW                       (408u)
...
#define MCUXCLHMAC_MAX_CONTEXT_SIZE                      (408u)
