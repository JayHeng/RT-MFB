...
static uint8_t const msg_plain[3u * MCUXCLAES_BLOCK_SIZE] = {
...
static uint8_t const msg_enc_expected[3u * MCUXCLAES_BLOCK_SIZE] = {
...
MCUXCLEXAMPLE_FUNCTION(mcuxClCipherModes_CBC_Oneshot_ELS_example)
{
    /**************************************************************************/
    /* Preparation                                                            */
    /**************************************************************************/
    ...
    MCUXCLEXAMPLE_ALLOCATE_AND_INITIALIZE_SESSION(session, MCUXCLCIPHER_AES_CRYPT_CPU_WA_BUFFER_SIZE + MCUXCLRANDOMMODES_NCINIT_WACPU_SIZE, 0u);
